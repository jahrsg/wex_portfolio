...
int main(int argc, char* argv[])
{
	try
	{
        ...
        double rur_price = trade.info("rur").lastPrice;
        double rur_total = total / rur_price;
        cout << "Total: " << total << "BTC (" << rur_total << " RUR)" << std::endl;
